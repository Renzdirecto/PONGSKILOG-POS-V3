...
- Expense records and items reject normal update/delete behavior. Audit metadata excludes receipt bytes/path and credentials. Offline/disconnected clients cannot submit and no irreversible expense is queued locally.
