...
Branding (2026-09-24): the round Pongskilog emblem (public/images/branding/pongskilog-emblem.png) is the brand mark beside the wordmark in the Owner/Super Admin sidebars and alone in their tablet rail and mobile top bar, the Operations header and auth screens; the Cashier POS rail keeps the pos.html wordmark. Browser/app icons, the Apple touch icon, PWA-ready 192/512 and maskable icons and the 1200×630 link-preview image derive from the square logo. No web manifest or service worker yet.
